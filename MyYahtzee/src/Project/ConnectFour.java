...
public class ConnectFour extends Game {
    ...
    private Scene scene;
    private Circle diskPreview;
    private Shape cell;
    private GridPane gridpane;
    private Text player1WinCount;
    private Text player2WinCount;
    ...
    void play(Stage primaryStage) {
        ...
        player1WinCount = new Text(players[0].name + "'s win count: " + player1Wins);
        player2WinCount = new Text(players[1].name + "'s win count: " + player2Wins);
        ...
        EventHandler<MouseEvent> returnToMainScreen = new EventHandler<MouseEvent>() {
            @Override
            public void handle(MouseEvent mouseEvent) {
                primaryStageCopy.setScene(menuScene);
        ...
        if (hasWon != -1) {
            ...
            if (hasWon == 1) {
                ...
                if (!result.isPresent()) {
                    ...
                    {
                        if (this.diskPreview.getFill() == Color.RED || this.diskPreview.getFill() == Color.YELLOW)
                            this.diskPreview.setFill(Color.TRANSPARENT);
                    }

                    primaryStageCopy.setScene(scene);
                    primaryStageCopy.show();
